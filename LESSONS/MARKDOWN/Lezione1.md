...
L'**intelligenza artificiale** (AI), da intendersi nell'ambito distaccato teorico piuttosto che informatico, serve per il lavoro al raggiungimento di uno scopo singolo utilizzando *macchine* intelligenti, che chiamiamo comunemente *software*.

L'appoggio al sistema hardware, che non andremo a realizzare per il solo motivo di sviluppare software intelligente, non è da intendersi stretto la *robotica*: negli ultimi tempi, questo termine viene piuttosto usato nel campo industriale; un distacco dei *robot*, dai sistemi software.
...
Come molti ambiti dell'informatica, il concetto di AI viene proposto per la prima volta nel '55, dal Prof. John McCarthy (1927-2011): il quesito di realizzare macchine intelligenti, che interagiscano con il mondo senza necessariamente parlare d'implementare algoritmi, nasce da lui.
...
- mettendo in campo una quantità spropositata di neuroni, che anche con computer moderni abbiamo difficoltà a fare;
