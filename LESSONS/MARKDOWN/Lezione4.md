...
| $$\tan(0.5x)$$                            | $$\tan(x)$$ |
| ----------------------------------------- | ----------- |
| Notare come l'algortimo riesca a trovare con successo un minimo locale ![[Pasted image 20230312175438.png\|300]] | L'algortimo ha trovato effettivamente un minimo locale, ma non il massimo locale (notare come le frecce puntino verso sinistra) ![[Pasted image 20230312175653.png\|300]]            |
